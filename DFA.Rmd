...
for(rr in 1:length(R.model)){ #loop over R structures 
  for(m in 1:3) { #Loop over 1-3 trends
      ...
      kemz=MARSS(MC.2018.t, model=dfa.model, control=cntl.list, form="dfa",  z.score=TRUE, fit=TRUE)
...
for(rr in 1:length(R.model)){ #loop over R structures 
  for(m in 1:3) { #loop over 1-3 trends
      modobj.m = list(c())
      dfa.model = list(A="zero", R=R.model[rr], m=m)
      kemz=MARSS(MC.2018.t, model=dfa.model, control=cntl.list, covariates=Discharge, form="dfa",  z.score=TRUE, fit=TRUE)
...
for(rr in 1:length(R.model)){ #loop over R structures 
  for(m in 1:3) { #loop over 1-3 trends
      modobj.m = list(c())
      dfa.model = list(A="zero", R=R.model[rr], m=m)
      kemz=MARSS(MC.2017.t, model=dfa.model, control=cntl.list, form="dfa",  z.score=TRUE, fit=TRUE)
...
for(rr in 1:length(R.model)){ #loop over R structures 
  for(m in 1:3) { #loop over 1-3 trends
      modobj.m = list(c())
      dfa.model = list(A="zero", R=R.model[rr], m=m)
      kemz=MARSS(MC.2017.t, model=dfa.model, control=cntl.list, covariates=Discharge7, form="dfa",  z.score=TRUE, fit=TRUE)
...
for(rr in 1:length(R.model)){ #loop over R structures 
  for(m in 1:3) { #loop over 1-3 trends
      modobj.m = list(c())
      dfa.model = list(A="zero", R=R.model[rr], m=m)
      kemz=MARSS(MC.2016.t, model=dfa.model, control=cntl.list, form="dfa",  z.score=TRUE, fit=TRUE)
...
for(rr in 1:length(R.model)){ #loop over R structures 
  for(m in 1:3) { #loop over 1-3 trends
      modobj.m = list(c())
      dfa.model = list(A="zero", R=R.model[rr], m=m)
      kemz=MARSS(MC.2016.t, model=dfa.model, control=cntl.list, covariates=Discharge6, form="dfa",  z.score=TRUE, fit=TRUE)
...
for(rr in 1:length(R.model)){ #loop over R structures 
  for(m in 1:3) { #loop over 1-3 trends
      modobj.m = list(c())
      dfa.model = list(A="zero", R=R.model[rr], m=m)
      kemz=MARSS(MC.2015.t, model=dfa.model, control=cntl.list, form="dfa",  z.score=TRUE, fit=TRUE)
...
for(rr in 1:length(R.model)){ #loop over R structures 
  for(m in 1:3) { #loop over 1-3 trends
      modobj.m = list(c())
      dfa.model = list(A="zero", R=R.model[rr], m=m)
      kemz=MARSS(MC.2015.t, model=dfa.model, control=cntl.list, covariates=Discharge5, form="dfa",  z.score=TRUE, fit=TRUE)
...
for(rr in 1:length(R.model)){ #loop over R structures 
  for(m in 1:3) {  #loop over 1-3 trends
      modobj.m = list(c())
      dfa.model = list(A="zero", R=R.model[rr], m=m)
      kemz=MARSS(SI.2018.t, model=dfa.model, control=cntl.list, form="dfa",  z.score=TRUE, fit=TRUE)
...
for(rr in 1:length(R.model)){ #loop over R structures 
  for(m in 1:3) { #loop over 1-3 trends
      modobj.m = list(c())
      dfa.model = list(A="zero", R=R.model[rr], m=m)
      kemz=MARSS(SI.2018.t, model=dfa.model, control=cntl.list, covariates=Discharge8s, form="dfa",  z.score=TRUE, fit=TRUE)
...
for(rr in 1:length(R.model)){ #loop over R structures 
  for(m in 1:3) { #loop over 1-3 trends
      modobj.m = list(c())
      dfa.model = list(A="zero", R=R.model[rr], m=m)
      kemz=MARSS(SI.2016.t, model=dfa.model, control=cntl.list, form="dfa",  z.score=TRUE, fit=TRUE)
...
for(rr in 1:length(R.model)){ #loop over R structures 
  for(m in 1:3) { #loop 1-3 trends
      modobj.m = list(c())
      dfa.model = list(A="zero", R=R.model[rr], m=m)
      kemz=MARSS(SI.2016.t, model=dfa.model, control=cntl.list, covariates=Discharge6s, form="dfa",  z.score=TRUE, fit=TRUE)
...
for(rr in 1:length(R.model)){ #loop over R structures 
  for(m in 1:3) { #loop over 1-3 trends
      modobj.m = list(c())
      dfa.model = list(A="zero", R=R.model[rr], m=m)
      kemz=MARSS(SI.2015.t, model=dfa.model, control=cntl.list, form="dfa",  z.score=TRUE, fit=TRUE)
...
for(rr in 1:length(R.model)){ #loop over R structures 
  for(m in 1:3) { #loop over 1-3 trends
      modobj.m = list(c())
      dfa.model = list(A="zero", R=R.model[rr], m=m)
      kemz=MARSS(SI.2015.t, model=dfa.model, control=cntl.list, covariates=Discharge5s, form="dfa",  z.score=TRUE, fit=TRUE)
...
for (i in 1:3) { ## plot the processes
...
#Probably don't need
All_Data<- rbind((MC2015DFA %>% filter(m=='3')%>% mutate(Desc= c("MC2015"))%>% mutate(AICcNorm=AICc- min(AICc))), 
                 (MC2016DFA %>% filter(m=='3')%>% mutate(Desc= c("MC2016"))%>% mutate(AICcNorm= AICc- min(AICc))), 
                 (MC2017DFA %>% filter(m=='3')%>% mutate(Desc= c("MC2017"))%>% mutate(AICcNorm= AICc-min(AICc))), 
                 (MC2018DFA %>% filter(m=='3')%>% mutate(Desc= c("MC2018"))%>% mutate(AICcNorm= AICc- min(AICc))), 
                 (SI2015DFA %>% filter(m=='3')%>% mutate(Desc= c("SI2015"))%>% mutate(AICcNorm= AICc- min(AICc))), 
                 (SI2016DFA %>% filter(m=='3')%>% mutate(Desc= c("SI2016"))%>% mutate(AICcNorm= AICc- min(AICc))), 
                 (SI2018DFA %>% filter(m=='3')%>% mutate(Desc= c("SI2018"))%>% mutate(AICcNorm= AICc- min(AICc))))
...
```{r BW vs MC For fit}
#Not corrected for 4 trends- probably don't need
...
#MC2015
for(k in 1:3){ #loop over R structures 
  for(i in 1:4) { #loop over 1-3 trends
    for(j in (i+1):5) {
